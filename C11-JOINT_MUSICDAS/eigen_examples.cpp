...
int main() {
	...
	std::cout << "--- abs(C(0,0)):\n" << abs(C(0,0)) << std::endl << std::endl;
	std::cout << "--- arg(C(0,0)):\n" << arg(C(0,0)) << std::endl << std::endl;
	...
	std::cout << "--- The first eigenvector:\n" << es_c.eigenvectors().col(1) << std::endl << std::endl;
