...
int jack_callback (jack_nframes_t nframes, void *arg){
	jack_default_audio_sample_t *in_1, *out_1, *in_2, *out_2;
	...
	memcpy (out_2, in_2, nframes * sizeof (jack_default_audio_sample_t));
...
int main (int argc, char *argv[]) {
    ...
    // Connect the second available to our input port
	if (jack_connect (client, serverports_names[1], jack_port_name (input_port_2))) {
